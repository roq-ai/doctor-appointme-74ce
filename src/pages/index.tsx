  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Doctor appointment system v1 - Simplifying your healthcare journey by streamlining appointment scheduling with your preferred physicians. Experience convenience at its best."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Doctor appointment system v1 - Simplifying your healthcare journey by streamlining appointment scheduling with your preferred physicians. Experience convenience at its best.`}
            </Text>
            <Box
